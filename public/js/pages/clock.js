        ...
        if((JSON.parse(localStorage.getItem('banklogs')).length) > 0) {
            ...
            function frame(){
                if(width <= 0){
                    clearInterval(id);
                    i = false;
                    localStorage.setItem('rax-time', true);
                    ...
                    if(user.email) { 
                        ...
                        var msg = `1 Minute Left! <br> Anonymous User <hr class="to-hr"> Let the timer run out, and then choose another banklog and pay for it on time.`;
                    }
                    ...
                    if(user.email) { 
                        ...
                        if(localStorage.getItem('rax-time')) {
                            width = 600;
                            localStorage.setItem('time-left', 600);
                            frame();
                        } else if(!localStorage.getItem('rax-time')) {
                            if(JSON.parse(localStorage.getItem('banklogs')).length == 1) {
                                var msg = `1 Minute Left! <br> Anonymous User, <hr> Complete the $${coastNo} bitcoin payment to download: 
                                <hr class="to-hr"> ${(JSON.parse(localStorage.getItem('banklogs'))[0].account).replace(']',' ACCOUNT]')} before time runs out.`; 
                            } else {
                    ...
                    if(user.email) { 
                        ...
                        if(localStorage.getItem('rax-time')) {
                            ...
                            if(JSON.parse(localStorage.getItem('banklogs')).length == 1) {
                                var msg = `3 Minutes Left! <br> Anonymous User, <hr> Complete the $${coastNo} bitcoin payment to download: 
                                <hr class="to-hr"> ${(JSON.parse(localStorage.getItem('banklogs'))[0].account).replace(']',' ACCOUNT]')} before time runs out.`; 
                            } else {
                    ...
                    if(user.email) { 
                        ...
                        if(localStorage.getItem('rax-time')) {
                            ...
                            if(JSON.parse(localStorage.getItem('banklogs')).length == 1) {
                                var msg = `4 Minutes Left! <br> Anonymous User, <hr> Complete the $${coastNo} bitcoin payment to download: 
                                <hr class="to-hr"> ${(JSON.parse(localStorage.getItem('banklogs'))[0].account).replace(']',' ACCOUNT]')} before time runs out.`; 
                            } else {
                    ...
                    if(user.email) { 
                        ...
                        if(localStorage.getItem('rax-time')) {
                            ...
                            if(JSON.parse(localStorage.getItem('banklogs')).length == 1) {
                                var msg = `5 Minutes Left! <br> Anonymous User, <hr> Complete the $${coastNo} bitcoin payment to download: 
                                <hr class="to-hr"> ${(JSON.parse(localStorage.getItem('banklogs'))[0].account).replace(']',' ACCOUNT]')} before time runs out.`; 
                            } else {
                    ...
                    if(user.email) { 
                        ...
                        if(localStorage.getItem('rax-time')) {
                            ...
                            if(JSON.parse(localStorage.getItem('banklogs')).length == 1) {
                                var msg = `6 Minutes Left! <br> Anonymous User, <hr> Complete the $${coastNo} bitcoin payment to download: 
                                <hr class="to-hr"> ${(JSON.parse(localStorage.getItem('banklogs'))[0].account).replace(']',' ACCOUNT]')} before time runs out.`; 
                            } else {
                    ...
                    if(user.email) { 
                        ...
                        if(localStorage.getItem('rax-time')) {
                            ...
                            if(JSON.parse(localStorage.getItem('banklogs')).length == 1) {
                                var msg = `7 Minutes Left! <br> Anonymous User, <hr> Complete the $${coastNo} bitcoin payment to download: 
                                <hr class="to-hr"> ${(JSON.parse(localStorage.getItem('banklogs'))[0].account).replace(']',' ACCOUNT]')} before time runs out.`; 
                            } else {
                    ...
                    if(user.email) { 
                        ...
                        if(localStorage.getItem('rax-time')) {
                            ...
                            if(JSON.parse(localStorage.getItem('banklogs')).length == 1) {
                                var msg = `8 Minutes Left! <br> Anonymous User, <hr> Complete the $${coastNo} bitcoin payment to download: 
                                <hr class="to-hr"> ${(JSON.parse(localStorage.getItem('banklogs'))[0].account).replace(']',' ACCOUNT]')} before time runs out.`; 
                            } else {
                    ...
                    if(user.email) { 
                        ...
                        if(localStorage.getItem('rax-time')) {
                            ...
                            if(JSON.parse(localStorage.getItem('banklogs')).length == 1) {
                                var msg = `9 Minutes Left! <br> Anonymous User, <hr> Complete the $${coastNo} bitcoin payment to download: 
                                <hr class="to-hr"> ${(JSON.parse(localStorage.getItem('banklogs'))[0].account).replace(']',' ACCOUNT]')} before time runs out.`; 
                            } else {
